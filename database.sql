...
VALUES
    (7, 'Bruce', 'Wayne', '2008-11-11', 'Night Roaster', 1),
    (8, 'Tony', 'Stark', '2010-07-15', 'Iron Barista', 2),
    (9, 'Peter', 'Parker', '2014-04-18', 'Spider Manager', 3);

INSERT INTO Coffee(coffee_id, shop_id, supplier_id, coffee_name, price_per_pound)
VALUES
    (10, 1, 4, 'Big Bean Dark', 13.49),
    (11, 2, 5, 'Firewood Medium', 11.99),
    (12, 3, 6, 'Brazil Light', 8.99);
